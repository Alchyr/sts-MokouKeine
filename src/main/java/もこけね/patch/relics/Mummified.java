...
public class Mummified {
    ...
    {
        if (TrackCardSource.useOtherEnergy && c.type == AbstractCard.CardType.POWER && AbstractDungeon.player instanceof MokouKeine)
        {
            __instance.flash();
            ...
            for (AbstractCard card : ((MokouKeine) AbstractDungeon.player).otherPlayerHand.group)
            {
