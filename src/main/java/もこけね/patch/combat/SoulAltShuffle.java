...
public class SoulAltShuffle {
    ...
    public static void changeGroup(Soul __instance, AbstractCard c, boolean isInvisible, @ByRef(type="com.megacrit.cardcrawl.cards.CardGroup") Object[] group)
    {
        if (altGroup != null)
        {
            group[0] = altGroup;
