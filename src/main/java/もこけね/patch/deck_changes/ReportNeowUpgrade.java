...
public class ReportNeowUpgrade {
    ...
    {
        if (AbstractDungeon.player.chosenClass == CharacterEnums.MOKOUKEINE && AbstractDungeon.player instanceof MokouKeine && MultiplayerHelper.active && AbstractDungeon.player.masterDeck.contains(c))
        {
