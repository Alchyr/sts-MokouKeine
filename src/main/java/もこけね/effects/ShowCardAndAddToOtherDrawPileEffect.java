...
public class ShowCardAndAddToOtherDrawPileEffect extends AbstractGameEffect {
    ...
    public ShowCardAndAddToOtherDrawPileEffect(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset, boolean toBottom) {
        ...
        {
            if (toBottom) {// 77
                ((MokouKeine) AbstractDungeon.player).otherPlayerDraw.addToBottom(srcCard);// 78
            } else if (randomSpot) {// 80
                ((MokouKeine) AbstractDungeon.player).otherPlayerDraw.addToRandomSpot(srcCard);// 81
            } else {
                ((MokouKeine) AbstractDungeon.player).otherPlayerDraw.addToTop(srcCard);// 83
            }
        }
        else
        {
