...
import もこけね.effects.CalmFireEffect;
import もこけね.effects.CasualFlameParticleEffect;
...
public class Spark extends CustomMonster {
    ...
    private static final float HB_WIDTH = 40.0F; //scale is all multiplied in abstract monster class
    private static final float HB_HEIGHT = 40.0F;
